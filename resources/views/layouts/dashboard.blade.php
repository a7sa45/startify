...
<html lang="ar" dir="rtl">
  <head>
    ...
    <title>Startify Dashboard</title>
...
<link href="{{ asset('css/bootstrap.rtl.min.css') }}" rel="stylesheet" integrity="sha384-WJUUqfoMmnfkBLne5uxXj+na/c7sesSJ32gI7GfCk4zO4GthUKhSEGyvQ839BC51" crossorigin="anonymous">
...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="#">Startify</a>
  ...
  <div class="navbar-nav">
    <div class="nav-item text-nowrap">
      <a class="nav-link px-3" href="/store/}">الانتقال الى المتجر</a>
    </div>
  </div>
</header>
