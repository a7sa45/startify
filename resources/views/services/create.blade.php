                ...
                <div class="card my-5 card-body cardbody-color p-lg-5">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/dashboard/services" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <input id="name" placeholder="اسم الخدمه" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                                @error('name')
